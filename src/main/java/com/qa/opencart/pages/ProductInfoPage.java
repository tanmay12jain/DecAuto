...
public class ProductInfoPage {
	...
	private By shopingcart = By.xpath("(//div[@class = 'alert alert-success alert-dismissible']//a)[2]");
...
//	Ex Tax: $2,000.00
	...
	public void addtocartwithQuantity() {
		...
		eleUtil.waitForElementVisible(inputQuantity,5).clear();
		eleUtil.doSendKeys(inputQuantity, "2");
		
		eleUtil.doClick(addToCart,TimeUtil.DEFAULT_SHORT_TIME);
	}
	
	public String successMessage() {
		 String successmsg = eleUtil.waitForElementVisible(successMessage,10).getText();
		return successmsg.substring(0, 58);
		 
	}
	
	public ShoppingCartPage shoppingCartClick() {
		TimeUtil.applyWait(5);
		eleUtil.doClick(shopingcart);
		TimeUtil.applyWait(5);
